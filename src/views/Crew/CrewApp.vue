...
<template>
    <div
        ...
        <transition appear enter-active-class="animate__animated animate__fadeIn">
            <div
             :key="activePerson"   class="lg:max-w-[65%] md:w-11/12 w-full px-5 md:px-0 md:h-[400px] md:m-auto lg:m-0 lg:h-[70%] flex lg:mt-10 justify-center  lg:items-end lg:flex-row md:mt-0 mt-5   ">
                <!-- (left) title and descripiton + carousel -->
                <div
                    class="flex flex-col lg:justify-around items-center lg:items-start  lg:w-[60%] md:w-full   lg:h-[500px]">
                    <!-- title -->
                    ...
                    <div class="flex gap-5 flex-col lg:w-full md:text-center lg:items-start items-center">
                        <!-- grade or post -->
                        <p ref="role"
                            class="text-white text-opacity-50 text-3xl font-BellefairRegular uppercase mt-5 lg:mt-0">
        ...
        <Transition appear enter-active-class="animate__animated animate__fadeIn">
            <div ref="image" :key="activePerson"
